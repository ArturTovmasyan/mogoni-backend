...
final class PublishProductAdmin extends AbstractAdmin
{
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        $showMapper
			...
			->add('goal')
			->add('roadmap')
			->add('screenshot', null, ['template' => 'Admin/Show/product_screenshots_show.html.twig'])
			->add('installation', null, ['template' => 'Admin/Show/product_installation_show.html.twig'])
			->add('example', null, ['template' => 'Admin/Show/product_example_show.html.twig'])
			->add('contact')
			->add('createdAt')
			->add('updatedAt')
			;
